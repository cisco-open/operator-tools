...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBase) DeepCopyInto(out *WorkloadBase) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBase.
func (in *WorkloadBase) DeepCopy() *WorkloadBase {
	if in == nil {
		return nil
	}
	out := new(WorkloadBase)
	in.DeepCopyInto(out)
	return out
}
